package com.sheziong.bootlaunchdemo.config;
...
@EnableJpaRepositories(basePackages = "com.sheziong.bootlaunchdemo.jpa.testdb2",   //注意这里
...
public class JPASecondaryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManager() throws Throwable {
        ...
        //这里要修改成主数据源的扫描包
        entityManager.setPackagesToScan("com.sheziong.bootlaunchdemo.jpa.testdb2");
